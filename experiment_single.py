...
def findIgnorablePeers(results):
    ...
    for name, res in results.items():
        if name not in ["GroupP2PBasic", "GroupP2PTimeout", "GroupP2PTimeoutSkip", "GroupP2PTimeoutRNN", "GroupP2PTimeoutIncRNN"]:
            continue
        for ag in res:
...
def main():
    ...
    allowed = ["BOLA", "FastMPC", "RobustMPC", "Penseiv", "GroupP2PBasic", "GroupP2PTimeout", "GroupP2PTimeoutSkip", "GroupP2PTimeoutInc", "GroupP2PTimeoutRNN", "GroupP2PTimeoutIncRNN", "DHT", "GroupP2PRNN"]
...
#     network = P2PNetwork("./graph/p2p-Gnutella04.txt")
    ...
    testCB["DHT"] = (DHT, traces, vi, network)
    ...
    testCB["GroupP2PRNN"] = (GroupP2PRNN, traces, vi, network, BOLA, None, "ModelPath")
